...
export const addMarkdownImport = (req, res) => {
    ...
    const markdownImportQuery = format(
        `INSERT INTO markdown (annotation_block, page_name, url_id, page_id, subject_name, users_id) VALUES %L`,
        markdownData
    );
...
export const updateMarkdown = (req, res) => {
    const id = req.params.id;
    const { annotation_block, page_name, url_id, page_id, subject_name } =
        req.body;
    ...
    pool.query(checkMarkdownExists, [id], (error, results) => {
        ...
        pool.query(
            updateMarkdownQuery,
            [annotation_block, page_name, url_id, page_id, subject_name, id],
            (error, results) => {
